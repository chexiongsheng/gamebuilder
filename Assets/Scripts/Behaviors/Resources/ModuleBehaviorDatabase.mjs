...
export { HANDLE_DYNAMIC_MESSAGES_FUNCTION_NAME };
export { MESSAGE_HANDLER_FUNCTION_NAME_PREFIX };
export { MESSAGE_HANDLER_FUNCTION_NAME_PREFIX_LEGACY };
export { ModuleBehavior };
export { ModuleBehaviorBrain };
export { ModuleBehaviorDatabase };
export { ModuleBehaviorUse };