...
class MessageHandlingContext {
  ...
  handleMessage(deliveredMessage, use) {
    ...
    //console.error(`handleMessage: ${JSON.stringify(deliveredMessage)} ${new Error().stack}`);
...
exports.Actor = Actor;
exports.FORCE_MEMORY_DIRTY = FORCE_MEMORY_DIRTY;
exports.MEM_CHECK_MODE = MEM_CHECK_MODE;
exports.MessageHandlingContext = MessageHandlingContext;
