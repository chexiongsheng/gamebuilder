...
// ActionCards
__voosModules["builtin:Add Velocity Card"] = addVelocityCard;
__voosModules["builtin:Alight Card"] = alightCard;
__voosModules["builtin:AutoPilotSetDestination"] = autoPilotSetDestination;
__voosModules["builtin:Board Card"] = boardCard;
__voosModules["builtin:BroadcastMessageActionCard"] = broadcastMessageActionCard;
__voosModules["builtin:CameraShakeActionCard"] = cameraShakeActionCard;
__voosModules["builtin:Cause Damage Card"] = causeDamageCard;
__voosModules["builtin:Change Camera Action Card"] = changeCameraActionCard;
__voosModules["builtin:Change Tint"] = changeTint;
__voosModules["builtin:Change Variable"] = changeVariable;
__voosModules["builtin:ChangeColor"] = changeColor;
__voosModules["builtin:DebugAction"] = debugAction;
__voosModules["builtin:Destroy Self Action Card"] = destroySelfActionCard;
__voosModules["builtin:DialogueActionCard"] = dialogueActionCard;
__voosModules["builtin:End Game LOSE Card"] = endGameLOSECard;
__voosModules["builtin:End Game WIN Card"] = endGameWINCard;
__voosModules["builtin:ExplodeActionCard"] = explodeActionCard;
__voosModules["builtin:Fire Projectile At Card"] = fireProjectileAtCard;
__voosModules["builtin:Fire Projectile Card"] = fireProjectileCard;
__voosModules["builtin:FireProjectileAtGroupCard"] = fireProjectileAtGroupCard;
__voosModules["builtin:Go Onstage"] = goOnstage;
__voosModules["builtin:Grab Action"] = grabAction;
__voosModules["builtin:Heal Damage Card"] = healDamageCard;
__voosModules["builtin:Hide Action Card"] = hideActionCard;
__voosModules["builtin:Jump Card"] = jumpCard;
__voosModules["builtin:Light Off Action"] = lightOffAction;
__voosModules["builtin:Light On Action"] = lightOnAction;
__voosModules["builtin:Move Action"] = moveAction;
__voosModules["builtin:Play Animation Action"] = playAnimationAction;
__voosModules["builtin:Play Sound"] = playSound;
__voosModules["builtin:Remove From Stage"] = removeFromStage;
__voosModules["builtin:Reset Game Card"] = resetGameCard;
__voosModules["builtin:Return To Spawn Point Action"] = returnToSpawnPointAction;
__voosModules["builtin:ReturnToCheckpointActionCard"] = returnToCheckpointActionCard;
__voosModules["builtin:Revive Action"] = reviveAction;
__voosModules["builtin:Say Something Action"] = saySomethingAction;
__voosModules["builtin:Score Point Action"] = scorePointAction;
__voosModules["builtin:SendMessage"] = sendMessage;
__voosModules["builtin:SendMessageActionCard2"] = sendMessageActionCard2;
__voosModules["builtin:SendMessageRandomActionCard"] = sendMessageRandomActionCard;
__voosModules["builtin:Set Checkpoint Card"] = setCheckpointCard;
__voosModules["builtin:ShowTextAction"] = showTextAction;
__voosModules["builtin:Spawn Particle Effect"] = spawnParticleEffect;
__voosModules["builtin:SpawnActorActionCard"] = spawnActorActionCard;
__voosModules["builtin:SpawnAtIntervals"] = spawnAtIntervals;
__voosModules["builtin:Teleport Action"] = teleportAction;
__voosModules["builtin:Transfer Player Action"] = transferPlayerAction;
__voosModules["builtin:UseGrabbedItemActionCard"] = useGrabbedItemActionCard;

// CameraCards
__voosModules["builtin:3P Camera Card"] = threePCameraCard;
__voosModules["builtin:FPS Camera Card"] = fpsCameraCard;
__voosModules["builtin:Top Down Camera Card"] = topDownCameraCard;

// DeprecatedCards
__voosModules["builtin:Cause Damage Self Card"] = causeDamageSelfCard;
__voosModules["builtin:Cause Damage To Target Card"] = causeDamageToTargetCard;
__voosModules["builtin:HealthBarsCard"] = healthBarsCard;
__voosModules["builtin:MoveOscillate"] = moveOscillate;
__voosModules["builtin:Player Controls Basic WASD"] = playerControlsBasicWASD;
__voosModules["builtin:Player Controls Car"] = playerControlsCar;
__voosModules["builtin:Player Controls Plane"] = playerControlsPlane;
__voosModules["builtin:Player Controls Point and Click"] = playerControlsPointAndClick;
__voosModules["builtin:SendMessageActionCard"] = sendMessageActionCard;
__voosModules["builtin:Someone Scores X Points"] = someoneScoresXPoints;

// DeprecatedPanels
__voosModules["builtin:AI Controls Panel"] = aiControlsPanel;
__voosModules["builtin:Player Controls Panel"] = playerControlsPanel;
__voosModules["builtin:Win Loss Panel"] = winLossPanel;

// EventCards
__voosModules["builtin:Actor Clicked Event Card"] = actorClickedEventCard;
__voosModules["builtin:Actor Count Predicate Card"] = actorCountPredicateCard;
__voosModules["builtin:Collision Event Card"] = collisionEventCard;
__voosModules["builtin:Game Start Event Card"] = gameStartEventCard;
__voosModules["builtin:InRangeEventCard"] = inRangeEventCard;
__voosModules["builtin:Killed All Actors Tagged"] = killedAllActorsTagged;
__voosModules["builtin:Player Button Event Card"] = playerButtonEventCard;
__voosModules["builtin:Random Predicate Card"] = randomPredicateCard;
__voosModules["builtin:ReceiveMessageEventCard"] = receiveMessageEventCard;
__voosModules["builtin:Scored X Points Event Card"] = scoredXPointsEventCard;
__voosModules["builtin:SeesActorEventCard"] = seesActorEventCard;
__voosModules["builtin:Spawned As Clone Event Card"] = spawnedAsCloneEventCard;
__voosModules["builtin:Terrain Collision Event Card"] = terrainCollisionEventCard;
__voosModules["builtin:Variable Predicate Card"] = variablePredicateCard;

// LegacyBehaviors
__voosModules["builtin:Blink"] = blink;
__voosModules["builtin:Button"] = button;
__voosModules["builtin:Coin"] = coin;
__voosModules["builtin:Default Behavior"] = defaultBehavior;
__voosModules["builtin:Destroy clones on reset"] = destroyClonesOnReset;
__voosModules["builtin:Destroy If Unclaimed Clone"] = destroyIfUnclaimedClone;
__voosModules["builtin:Dialog box"] = dialogBox;
__voosModules["builtin:Does damage"] = doesDamage;
__voosModules["builtin:Elevator"] = elevator;
//__voosModules["builtin:FireProjectile"] = fireProjectile;
__voosModules["builtin:Follow nearest"] = followNearest;
__voosModules["builtin:Follow"] = follow;
__voosModules["builtin:Grabbable"] = grabbable;
__voosModules["builtin:Grabbing"] = grabbing;
__voosModules["builtin:Grid Spawner"] = gridSpawner;
__voosModules["builtin:Hide in play mode"] = hideInPlayMode;
__voosModules["builtin:Isometric Auto-Run Controls"] = isometricAutoRunControls;
__voosModules["builtin:Key"] = key;
__voosModules["builtin:Look at"] = lookAt;
__voosModules["builtin:Mountable"] = mountable;
__voosModules["builtin:Mounting"] = mounting;
__voosModules["builtin:Move forward"] = moveForward;
__voosModules["builtin:Openable gate"] = openableGate;
__voosModules["builtin:Physics"] = physics;
__voosModules["builtin:Place block"] = placeBlock;
__voosModules["builtin:Player Controls"] = playerControls;
__voosModules["builtin:Respawning"] = respawning;
__voosModules["builtin:Run in circles"] = runInCircles;
__voosModules["builtin:Score on death"] = scoreOnDeath;
__voosModules["builtin:Score or win on contact"] = scoreOrWinOnContact;
__voosModules["builtin:Self-destruct"] = selfDestruct;
__voosModules["builtin:Side to side"] = sideToSide;
__voosModules["builtin:Snake forward"] = snakeForward;
__voosModules["builtin:Spawner"] = spawner;
__voosModules["builtin:Takes damage"] = takesDamage;
__voosModules["builtin:Team"] = team;
__voosModules["builtin:Text box"] = textBox;
__voosModules["builtin:Throw something"] = throwSomething;
__voosModules["builtin:Trampoline"] = trampoline;
__voosModules["builtin:Turn randomly"] = turnRandomly;
__voosModules["builtin:Win by points"] = winByPoints;
__voosModules["builtin:Wizard Controller"] = wizardController;

// MoveCards
__voosModules["builtin:Back And Forth"] = backAndForth;
__voosModules["builtin:MoveAutoPilot"] = moveAutoPilot;
__voosModules["builtin:MoveChase"] = moveChase;
__voosModules["builtin:MoveInOneDirection"] = moveInOneDirection;
__voosModules["builtin:MoveLookAt"] = moveLookAt;
__voosModules["builtin:MovePath"] = movePath;
__voosModules["builtin:MoveRandomWalk"] = moveRandomWalk;
__voosModules["builtin:Player Camera Look"] = playerCameraLook;
__voosModules["builtin:Player Speed Based Turn"] = playerSpeedBasedTurn;
__voosModules["builtin:Player Speed Throttle"] = playerSpeedThrottle;
__voosModules["builtin:Player Walk Card"] = playerWalkCard;
__voosModules["builtin:Spin"] = spin;
__voosModules["builtin:Turn"] = turn;

// Panels
__voosModules["builtin:Action on Event Panel"] = actionOnEventPanel;
__voosModules["builtin:Always Panel"] = alwaysPanel;
__voosModules["builtin:Boardable Panel"] = boardablePanel;
__voosModules["builtin:Camera Panel"] = cameraPanel;
__voosModules["builtin:Game Start Panel"] = gameStartPanel;
__voosModules["builtin:Grab Panel"] = grabPanel;
__voosModules["builtin:Grabbable Item Panel"] = grabbableItemPanel;
__voosModules["builtin:Health Panel"] = healthPanel;
__voosModules["builtin:Movement Panel"] = movementPanel;
__voosModules["builtin:Player Controls Panel v2"] = playerControlsPanelV2;
__voosModules["builtin:Screen Panel"] = screenPanel;
__voosModules["builtin:Switch Panel"] = switchPanel;
__voosModules["builtin:TimerActionPanel"] = timerActionPanel;

// ScreenCards
__voosModules["builtin:FloatingHealthBar"] = floatingHealthBar;
__voosModules["builtin:HealthBar"] = healthBar;
__voosModules["builtin:ScoreBoard"] = scoreBoard;
__voosModules["builtin:ShowVariableCard"] = showVariableCard;
__voosModules["builtin:Static Text Card"] = staticTextCard;

// Specs
__voosModules["builtin:spec_GActionCard"] = specGActionCard;
__voosModules["builtin:spec_GActionMessage"] = specGActionMessage;
__voosModules["builtin:spec_GEvent"] = specGEvent;
__voosModules["builtin:spec_GEventCard"] = specGEventCard;
