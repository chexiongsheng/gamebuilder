...
// ESM exports
export { addVelocityPlease };
export { applyQuaternionPlease };
export { applyQuaternionSelfPlease };
export { attachToParentPlease };
export { deleteVarPlease };
export { destroySelfPlease };
export { detachFromParentPlease };
export { enableGravityPlease };
export { enableKeepUprightPlease };
export { hidePlease };
export { lookAtPlease };
export { lookDirPlease };
export { resetRotPlease };
export { setAngularDragPlease };
export { setBodyPosPlease };
export { setBodyRotPlease };
export { setBouncinessPlease };
export { setCameraActorPlease };
export { setCommentTextPlease };
export { setControllingPlayerPlease };
export { setDisplayNamePlease };
export { setDragPlease };
export { setIsPlayerControllablePlease };
export { setKinematicPlease };
export { setMassPlease };
export { setPhysicsPresetPlease };
export { setPitchPlease };
export { setPosPlease };
export { setRollPlease };
export { setRotPlease };
export { setScalePlease };
export { setScaleUniformPlease };
export { setSolidPlease };
export { setTintColorPlease };
export { setTintHexPlease };
export { setVarPlease };
export { setYawPitchRollPlease };
export { setYawPlease };
export { showPlease };
export { turnPlease };
