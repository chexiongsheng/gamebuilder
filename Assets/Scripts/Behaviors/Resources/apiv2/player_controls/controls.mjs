...
// ESM exports
export { getCameraActor };
export { getControllingPlayer };
export { getLookAxes };
export { getRawThrottle };
export { getThrottle };
export { getWorldThrottle };
export { isGrounded };
export { isPlayerControllable };
export { isSprinting };
export { resetCameraActor };
export { setCameraActor };
export { setControllingPlayer };
export { setIsPlayerControllable };
