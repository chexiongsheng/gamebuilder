...
exports.getLocalPos = getLocalPos;
exports.getPos = getPos;
exports.getPosX = getPosX;
exports.getPosY = getPosY;
exports.getPosZ = getPosZ;
exports.getSpawnPos = getSpawnPos;
exports.selfToWorldDir = selfToWorldDir;
exports.selfToWorldPos = selfToWorldPos;
exports.worldToSelfDir = worldToSelfDir;
exports.worldToSelfPos = worldToSelfPos;
