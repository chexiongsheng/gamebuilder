...
export { destroySelf };
export { exists };
export { getActorGroupDescription };
export { getActorWithTag };
export { getActors };
export { getActorsInGroup };
export { getActorsWithTag };
export { getCardTargetActor };
export { getCardTargetActorDescription };
export { getClosestActor };
export { getGameRulesActor };
export { getPlayerActors };
export { goOffstage };
export { goOnstage };
export { hasTag };
export { isActorInGroup };
export { isOffstage };
export { isOnstage };
export { myself };
