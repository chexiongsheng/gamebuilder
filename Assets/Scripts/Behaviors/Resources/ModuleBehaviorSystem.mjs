...
import { sysLog, queueMessageToUnity, enqueueRemoteMessage, getVoosEngine } from "./voosMain.mjs";
...
// ESM exports
export { MAX_ACTORS };
export { MESSAGES_THAT_SHOULD_NOT_BE_FORWARDED };
export { MESSAGES_TO_DELIVER_LOCALLY_TO_REMOTE_ACTORS };
export { ModuleBehaviorSystem };
export { getBehaviorProperties };