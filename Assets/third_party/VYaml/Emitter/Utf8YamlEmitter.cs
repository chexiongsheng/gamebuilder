...
namespace VYaml.Emitter
{
  ...
  {
    static byte[] whiteSpaces = System.Text.Encoding.UTF8.GetBytes("                                ");
    static readonly byte[] FlowSequenceEmpty = System.Text.Encoding.UTF8.GetBytes("[]");
    static readonly byte[] FlowSequenceEmptyWithSpace = System.Text.Encoding.UTF8.GetBytes(" []");
    static readonly byte[] FlowSequenceSeparator = System.Text.Encoding.UTF8.GetBytes(", ");
    static readonly byte[] FlowMappingHeader = System.Text.Encoding.UTF8.GetBytes("{ ");
    static readonly byte[] FlowMappingFooter = System.Text.Encoding.UTF8.GetBytes(" }");
    static readonly byte[] FlowMappingEmpty = System.Text.Encoding.UTF8.GetBytes("{}");
    static readonly byte[] FlowMappingEmptyWithSpace = System.Text.Encoding.UTF8.GetBytes(" {}");
              ...
              default:
                {
                  ...
                  var offset = 0;
                  var withSpace = CurrentState == EmitState.FlowMappingValue || CurrentState == EmitState.BlockMappingValue;
                  if (withSpace)
                  {
                    output[offset++] = YamlCodes.Space;
                  }
        ...
        case EmitState.BlockSequenceEntry:
          {
            ...
            if (isEmptySequence)
            {
              var lineBreak = CurrentState == EmitState.BlockSequenceEntry || CurrentState == EmitState.BlockMappingValue;
              var space = CurrentState == EmitState.BlockMappingValue || CurrentState == EmitState.FlowMappingValue || CurrentState == EmitState.BlockSequenceEntry;
